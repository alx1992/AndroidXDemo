...
public class GlobalDialogSingle extends Dialog {
    ...
    protected GlobalDialogSingle(@NonNull Context context, boolean cancelable, @Nullable DialogInterface.OnCancelListener cancelListener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.global_dialog_one);
